// Q1 An image is represented by an m x n integer grid image where image[i][j] represents the 
...
// directionally to those pixels (also with the same color), and so on. Replace the color of all of 
