// Q1 You are given a list of bombs. The range of a bomb is defined as the area where its effect 
...
// bombs that lie in its range. These bombs will further detonate the bombs that lie in their 
// ranges.
